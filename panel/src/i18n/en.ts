export const en = {
  ...
  chat_empty_auto: "All tool calls run without prompts.",
  chat_empty_safe: "Type a message, or send one from Telegram. Risky tool calls will prompt for approval here in the panel.",
  chat_allow: "Allow",
