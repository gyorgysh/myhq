export const en = {
  ...
  chat_safe: "○ safe",
  chat_clear: "Clear",
  chat_empty: "Send direct orders or one-shot questions. No conversational memory between turns — each prompt runs fresh.",
  chat_empty_tip: "For back-and-forth conversation use Telegram, where context carries across messages.",
  ...
  chat_deny: "Deny",
  chat_placeholder: "Direct order or question… (Enter to send, Shift+Enter for newline)",
  chat_send: "Send",
  chat_failed: "(failed)",
