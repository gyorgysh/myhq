...
export const hu: Translations = {
  ...
  chat_clear: "Törlés",
  chat_empty: "Közvetlen utasítások vagy egyszeri kérdések küldésére való. Nincs kontextusmemória az üzenetek között — minden prompt frissen indul.",
  chat_empty_tip: "Oda-vissza beszélgetéshez használd a Telegramot, ahol a kontextus megmarad az üzenetek között.",
  ...
  chat_placeholder: "Közvetlen utasítás vagy kérdés… (Enter a küldéshez, Shift+Enter új sorhoz)",
  chat_send: "Küldés",
